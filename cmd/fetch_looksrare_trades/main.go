...
const CONTRACT_ADDRESS = "0x59728544b08ab483533076417fbbb2fd0b17ce3a"
const EVENT = "TakerBid" // need both TakerBid and TakerAsk
...
- offset: %v`,
	...
	for {
		...
		// save to db
		err = db.SaveLooksRareTrades(network, events)
		if err != nil {
